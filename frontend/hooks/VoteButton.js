  ...
  return (
    <>
      <Box display="flex" flexDirection="column" alignItems="center" gap={1}>
        <Button aria-label="Like" onClick={() => handleVote(upload._id, "like")} colorScheme={upload.isLiked ? "green" : "gray"} variant="outline" isDisabled={!isAuthenticated || isLoading}>
      ...
      <Box display="flex" flexDirection="column" alignItems="center" gap={1}>
        <Button aria-label="Dislike" onClick={() => handleVote(upload._id, "dislike")} colorScheme={upload.isDisliked ? "red" : "gray"} variant="outline" isDisabled={!isAuthenticated || isLoading}>
