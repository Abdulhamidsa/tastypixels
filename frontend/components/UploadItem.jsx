      ...
      <Box p="4" bg="gray.200" color="black">
        <Flex alignItems="center">
          <Flex alignItems="center" mr="2">
            <IconButton
              icon={<FaArrowUp />}
              isLoading={loadingVote[upload._id] === 'like'}
              colorScheme={upload.isLiked ? 'orange' : 'gray'}
              aria-label="Upvote"
            ...
            <IconButton
              icon={<FaArrowDown />}
              isLoading={loadingVote[upload._id] === 'dislike'}
              colorScheme={upload.isDisliked ? 'red' : 'gray'}
              aria-label="Downvote"
